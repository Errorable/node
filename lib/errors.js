...
util.define(errors, 'APP_ID_ERROR', util.make(entities.APPLICATION, 0, events.NONE, types.ERROR));
util.define(errors, 'APPLICATION_ID_ERROR', util.make(entities.APPLICATION, 0, events.NONE, types.ERROR));
